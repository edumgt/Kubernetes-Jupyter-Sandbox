...
export async function ensureDefaultUsers() {
  const adminPassword =
    process.env.DEFAULT_ADMIN_PASSWORD || process.env.CONTROL_PLANE_PASSWORD || "CHANGE_ME";
  const userPassword = process.env.DEFAULT_TEST_USER_PASSWORD || "CHANGE_ME";
  const defaults = [
    { username: "admin@test.com", password: adminPassword, role: "admin", displayName: "Platform Admin" },
    { username: "test1@test.com", password: userPassword, role: "user", displayName: "Test User 1" },
  ];
