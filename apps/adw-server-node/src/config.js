...
export const config = {
  ...
  appName: process.env.APP_NAME || "fss-adw-server-node",
  mongoUri:
    process.env.MONGO_URI ||
    "mongodb://root:CHANGE_ME@mongo.infra.svc.cluster.local:27017/fss_adw?authSource=admin",
  redisUrl:
  ...
  jupyterImage:
    process.env.JUPYTER_IMAGE || "harbor.local/dis/jupyter-teradata-extension:latest",
  ...
  frontendUrl: process.env.FRONTEND_URL || "http://adw.local",
